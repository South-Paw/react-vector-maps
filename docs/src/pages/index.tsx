...
export default function IndexPage() {
  return (
      ...
      hero={
        <HeroWrapper>
          <Item basis={70}>
            ...
            <p>
              A React component for creating simple maps with interactive elements, 100+ maps ready for use and an
              online SVG to JSON converter for creating new maps.
            </p>
    ...
    >
      ...
      <p>
        You might be interested in some <Link to="/examples">examples</Link> of how the component can be used and note
        that you can also turn your own SVG into a valid map with our <Link to="/converter">converter</Link>.
      </p>
      <p>Stars on the project are always appreciated! 🙂</p>
      <p>
        To report an issue or contribute to the project please visit our{' '}
